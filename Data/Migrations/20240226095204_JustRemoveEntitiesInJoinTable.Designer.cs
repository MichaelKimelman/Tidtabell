...
namespace Tidtabell.Data.Migrations
{
    ...
    [Migration("20240226095204_JustRemoveEntitiesInJoinTable")]
    partial class JustRemoveEntitiesInJoinTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tidtabell.Models.Join_Tables.LineStops", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tidtabell.Models.Join_Tables.LineStops", b =>
                {
                    b.HasOne("Tidtabell.Models.Line", null)
                        .WithMany("LineStops")
                        .HasForeignKey("LineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tidtabell.Models.Stop", null)
                        .WithMany("LineStops")
